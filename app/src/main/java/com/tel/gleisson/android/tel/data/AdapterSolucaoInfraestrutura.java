...
public class AdapterSolucaoInfraestrutura  extends FirebaseRecyclerAdapter<SolucaoObjeto, ViewHolderRecuperaSolucao> {
    Context context;
    SolucaoObjeto solucaoObjeto;

    public AdapterSolucaoInfraestrutura(Context context, Class<SolucaoObjeto> modelClass, int modelLayout, Class<ViewHolderRecuperaSolucao> viewHolderClass, DatabaseReference ref) {
    ...
    protected void populateViewHolder(ViewHolderRecuperaSolucao viewHolder, SolucaoObjeto model, int position) {
        ...
        ArraySolucoes.infra.add(position,model);
    ...
    public void onBindViewHolder(ViewHolderRecuperaSolucao viewHolder, final int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                solucaoObjeto = ArraySolucoes.infra.get(position);
